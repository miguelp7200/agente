...
# ==================================================
# Original: test_search_invoices_recent_by_date.ps1
...
# ==================================================
# Test: test_search_invoices_recent_by_date
# Query: "Dame las 10 facturas más recientes"
# Expected Tool: search_invoices_recent_by_date
# Batch: 1

$sessionId = "search_invoices_recent_by_date-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_recent_by_date" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'Dame las 10 facturas más recientes'" -ForegroundColor Yellow
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_recent_by_date_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
