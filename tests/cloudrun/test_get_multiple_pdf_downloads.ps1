...
# ==================================================
# Original: test_get_multiple_pdf_downloads.ps1
...
# Expected Tool: get_multiple_pdf_downloads
# Batch: 2

$sessionId = "get_multiple_pdf_downloads-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_multiple_pdf_downloads" -ForegroundColor Cyan
...
# Guardar resultado
$outputFile = ".\test_results\test_get_multiple_pdf_downloads_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
