...
# ==================================================
# Original: test_search_invoices_by_minimum_amount.ps1
...
# Query: "dame facturas con monto mayor a 1000000"
# Expected Tool: search_invoices_by_minimum_amount
# Batch: 1

$sessionId = "search_invoices_by_minimum_amount-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_minimum_amount" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame facturas con monto mayor a 1000000'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame facturas con monto mayor a 1000000"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_minimum_amount_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
