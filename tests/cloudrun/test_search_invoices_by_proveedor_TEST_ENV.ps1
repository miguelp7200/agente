...
# Purpose: Verify search by proveedor with parallel ZIP download
# ==================================================
# Test: test_search_invoices_by_proveedor
# Query: "dame las facturas de comercializadora pimentel para octubre 2023"

$sessionId = "search_proveedor_TEST-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_proveedor [TEST ENV]" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "🌍 Endpoint: $backendUrl" -ForegroundColor Yellow
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame las facturas de comercializadora pimentel para octubre 2023'" -ForegroundColor Yellow
Write-Host "========================================`n" -ForegroundColor Cyan
