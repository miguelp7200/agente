...
# ==================================================
# Original: test_search_invoices_by_rut_and_date_range.ps1
...
# Expected Tool: search_invoices_by_rut_and_date_range
# Batch: 1

$sessionId = "search_invoices_by_rut_and_date_range-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_rut_and_date_range" -ForegroundColor Cyan
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_rut_and_date_range_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
