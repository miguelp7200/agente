...
# ==================================================
# Original: test_get_tributarias_by_solicitante.ps1
...
# ==================================================
# Test: test_get_tributarias_by_solicitante
# Query: "dame todos los PDFs tributarios del solicitante 0012148561"
# Expected Tool: get_tributarias_by_solicitante
# Batch: 2

$sessionId = "get_tributarias_by_solicitante-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_tributarias_by_solicitante" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame todos los PDFs tributarios del solicitante 0012148561'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame todos los PDFs tributarios del solicitante 0012148561"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_tributarias_by_solicitante_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
