...
# Purpose: Verify search by date with signed URLs
# ==================================================
# Test: test_search_invoices_by_date
# Query: "dame las facturas del 08-09-2025"

$sessionId = "search_by_date_TEST-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_date [TEST ENV]" -ForegroundColor Cyan
