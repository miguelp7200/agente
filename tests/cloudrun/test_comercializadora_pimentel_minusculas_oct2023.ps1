...
# ==================================================
# Original: test_comercializadora_pimentel_minusculas_oct2023.ps1
...
# ==================================================
# ===== SCRIPT PRUEBA COMERCIALIZADORA PIMENTEL OCTUBRE 2023 (MINÚSCULAS) =====

# Paso 1: Configurar variables para desarrollo local
$sessionId = "comercializadora-pimentel-minusculas-oct2023-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
$appName = "gcp-invoice-agent-app"
$backendUrl = "https://invoice-backend-yuhrx5x2ra-uc.a.run.app"  # Cloud Run Production URL

Write-Host "📋 Variables configuradas para prueba COMERCIALIZADORA PIMENTEL (minúsculas):" -ForegroundColor Cyan
...
Write-Host "Expected: Debería encontrar la misma factura del 2023-10-30 (normalización UPPER)" -ForegroundColor Gray
Write-Host "Status: VALIDANDO CASE-INSENSITIVE - Debería dar el mismo resultado" -ForegroundColor Green
