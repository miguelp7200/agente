...
# ==================================================
# Original: test_search_invoices_by_proveedor.ps1
...
# ==================================================
# Test: test_search_invoices_by_proveedor
# Query: "dame facturas de Comercializadora Pimentel"
# Expected Tool: search_invoices_by_proveedor
# Batch: 3

$sessionId = "search_invoices_by_proveedor-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_proveedor" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame facturas de Comercializadora Pimentel'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame facturas de Comercializadora Pimentel"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_proveedor_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
