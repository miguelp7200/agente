...
# ==================================================
# Original: test_get_data_coverage_statistics.ps1
...
# ==================================================
# Test: test_get_data_coverage_statistics
# Query: "cuál es la cobertura de años del dataset?"
# Expected Tool: get_data_coverage_statistics
# Batch: 3

$sessionId = "get_data_coverage_statistics-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_data_coverage_statistics" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'cuál es la cobertura de años del dataset?'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "cuál es la cobertura de años del dataset?"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_data_coverage_statistics_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
