...
# ==================================================
# Original: test_search_invoices_by_date.ps1
...
# ==================================================
# Test: test_search_invoices_by_date
# Query: "dame las facturas del 08-09-2025"
# Expected Tool: search_invoices_by_date
# Batch: 1

$sessionId = "search_invoices_by_date-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_date" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame las facturas del 08-09-2025'" -ForegroundColor Yellow
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_date_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
