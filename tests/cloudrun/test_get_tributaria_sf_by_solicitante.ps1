...
# ==================================================
# Original: test_get_tributaria_sf_by_solicitante.ps1
...
# ==================================================
# Test: test_get_tributaria_sf_by_solicitante
# Query: "dame los PDFs tributarios sin formato del solicitante 0012148561"
# Expected Tool: get_tributaria_sf_by_solicitante
# Batch: 2

$sessionId = "get_tributaria_sf_by_solicitante-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_tributaria_sf_by_solicitante" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame los PDFs tributarios sin formato del solicitante 0012148561'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame los PDFs tributarios sin formato del solicitante 0012148561"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_tributaria_sf_by_solicitante_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
