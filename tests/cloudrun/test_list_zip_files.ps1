...
# ==================================================
# Original: test_list_zip_files.ps1
...
# ==================================================
# Test: test_list_zip_files
# Query: "qué archivos ZIP tengo disponibles?"
# Expected Tool: list_zip_files
# Batch: 3

$sessionId = "list_zip_files-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: list_zip_files" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'qué archivos ZIP tengo disponibles?'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "qué archivos ZIP tengo disponibles?"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_list_zip_files_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
