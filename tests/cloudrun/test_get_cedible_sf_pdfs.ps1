...
# ==================================================
# Original: test_get_cedible_sf_pdfs.ps1
...
# ==================================================
# Test: test_get_cedible_sf_pdfs
# Query: "dame todas las facturas que tienen PDF cedible SF"
# Expected Tool: get_cedible_sf_pdfs
# Batch: 3

$sessionId = "get_cedible_sf_pdfs-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_cedible_sf_pdfs" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame todas las facturas que tienen PDF cedible SF'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame todas las facturas que tienen PDF cedible SF"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_cedible_sf_pdfs_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
