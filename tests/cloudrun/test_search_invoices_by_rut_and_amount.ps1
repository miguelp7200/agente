...
# ==================================================
# Original: test_search_invoices_by_rut_and_amount.ps1
...
# ==================================================
# Test: test_search_invoices_by_rut_and_amount
# Query: "dame facturas del RUT 96568740 con monto mayor a 500000"
# Expected Tool: search_invoices_by_rut_and_amount
# Batch: 2

$sessionId = "search_invoices_by_rut_and_amount-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_rut_and_amount" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame facturas del RUT 96568740 con monto mayor a 500000'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame facturas del RUT 96568740 con monto mayor a 500000"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_rut_and_amount_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
