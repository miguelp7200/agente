...
# ==================================================
# Original: test_get_zip_statistics.ps1
...
# ==================================================
# Test: test_get_zip_statistics
# Query: "cuántos archivos ZIP se han generado?"
# Expected Tool: get_zip_statistics
# Batch: 3

$sessionId = "get_zip_statistics-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_zip_statistics" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'cuántos archivos ZIP se han generado?'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "cuántos archivos ZIP se han generado?"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_zip_statistics_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
