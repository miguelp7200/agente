...
# ==================================================
# Original: test_search_invoices_by_factura_number.ps1
...
# ==================================================
# Test: test_search_invoices_by_factura_number
# Query: "necesito me busques factura 0105473148"
# Expected Tool: search_invoices_by_factura_number
# Batch: 1

$sessionId = "search_invoices_by_factura_number-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: search_invoices_by_factura_number" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'necesito me busques factura 0105473148'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "necesito me busques factura 0105473148"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_search_invoices_by_factura_number_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
