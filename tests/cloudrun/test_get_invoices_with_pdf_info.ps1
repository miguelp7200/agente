...
# ==================================================
# Original: test_get_invoices_with_pdf_info.ps1
...
# ==================================================
# Test: test_get_invoices_with_pdf_info
# Query: "dame facturas con información de qué PDFs tienen disponibles"
# Expected Tool: get_invoices_with_pdf_info
# Batch: 3

$sessionId = "get_invoices_with_pdf_info-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "victor-local"
...
Write-Host "TEST: get_invoices_with_pdf_info" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Session ID: $sessionId" -ForegroundColor Gray
Write-Host "Query: 'dame facturas con información de qué PDFs tienen disponibles'" -ForegroundColor Yellow
...
$requestBody = @{
    ...
    sessionId = $sessionId
    newMessage = @{
        parts = @(@{text = "dame facturas con información de qué PDFs tienen disponibles"})
        role = "user"
    }
...
# Guardar resultado
$outputFile = ".\test_results\test_get_invoices_with_pdf_info_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
