# ===== SCRIPT CURL AUTOMATIZADO: Test: Última Factura Registrada =====
<#
.SYNOPSIS
    Test automatizado: Test: Última Factura Registrada

.DESCRIPTION
    Script generado automáticamente para validar: Valida que el agente pueda identificar y mostrar la factura más reciente en el sistema. Test crítico para validar ordenamiento temporal.
...
.EXAMPLE
    .\curl_test_Test:_Última_Factura_Registrada.ps1
    
.EXAMPLE  
    .\curl_test_Test:_Última_Factura_Registrada.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Test: Última Factura Registrada" -ForegroundColor Magenta
...
🔍 Validando contenido requerido..." -ForegroundColor Yellow
        $requiredContent = @("última", "factura", "registrada", "2025")
...
Write-Success "Test Test: Última Factura Registrada completado!"
