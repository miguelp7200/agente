# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices Recent By Date =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices Recent By Date

.DESCRIPTION
    Script generado automáticamente para validar: Buscar las facturas más recientes sin especificar fecha exacta
    
    Test Case: search_invoices_recent_by_date
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_recent_by_date.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_recent_by_date.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices Recent By Date" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_recent_by_date-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "Dame las 10 facturas más recientes"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Search Invoices Recent By Date"
        ...
        $resultFile = "../../results/result_search_invoices_recent_by_date_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices Recent By Date completado!"
