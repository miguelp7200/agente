# ===== SCRIPT CURL AUTOMATIZADO: Solicitante 0012537749 Todas Facturas =====
<#
.SYNOPSIS
    Test automatizado: Solicitante 0012537749 Todas Facturas

.DESCRIPTION
    Script generado automáticamente para validar: Test comprehensive invoice search for solicitante 0012537749 without date filters
    
    Test Case: solicitante_0012537749_todas_facturas
    Categoría: search
...
.EXAMPLE
    .\curl_test_solicitante_0012537749_todas_facturas.ps1
    
.EXAMPLE  
    .\curl_test_solicitante_0012537749_todas_facturas.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Solicitante 0012537749 Todas Facturas" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-solicitante_0012537749_todas_facturas-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "para el solicitante 0012537749 traeme todas las facturas que tengas"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Solicitante 0012537749 Todas Facturas"
        ...
        $resultFile = "../../results/result_solicitante_0012537749_todas_facturas_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Solicitante 0012537749 Todas Facturas completado!"
