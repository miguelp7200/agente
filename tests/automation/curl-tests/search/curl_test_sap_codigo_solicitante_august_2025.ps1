# ===== SCRIPT CURL AUTOMATIZADO: Sap Codigo Solicitante August 2025 =====
<#
.SYNOPSIS
    Test automatizado: Sap Codigo Solicitante August 2025

.DESCRIPTION
    Script generado automáticamente para validar: Test SAP recognition and automatic code normalization for August 2025
    
    Test Case: sap_codigo_solicitante_august_2025
    Categoría: search
...
.EXAMPLE  
    .\curl_test_sap_codigo_solicitante_august_2025.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Sap Codigo Solicitante August 2025" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-sap_codigo_solicitante_august_2025-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame la factura del siguiente sap, para agosto 2025 - 12537749"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Sap Codigo Solicitante August 2025"
        ...
        $resultFile = "../../results/result_sap_codigo_solicitante_august_2025_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Sap Codigo Solicitante August 2025 completado!"
