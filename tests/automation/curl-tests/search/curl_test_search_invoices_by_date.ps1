# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Date =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Date

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas por fecha específica usando formato DD-MM-YYYY
    
    Test Case: search_invoices_by_date
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_date.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_date.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Date" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_date-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas del 08-09-2025"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_by_date"
            test_name = "Search Invoices By Date"
        ...
        $resultFile = "../../results/result_search_invoices_by_date_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Date completado!"
