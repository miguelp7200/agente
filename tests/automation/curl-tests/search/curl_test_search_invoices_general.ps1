# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices General =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices General

.DESCRIPTION
    Script generado automáticamente para validar: Búsqueda general de facturas sin filtros específicos
    
    Test Case: search_invoices_general
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_general.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_general.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices General" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_general-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "muéstrame facturas"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_general"
            test_name = "Search Invoices General"
        ...
        $resultFile = "../../results/result_search_invoices_general_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices General completado!"
