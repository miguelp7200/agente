# ===== SCRIPT CURL AUTOMATIZADO: Invoice Reference Search 8677072 =====
<#
.SYNOPSIS
    Test automatizado: Invoice Reference Search 8677072

.DESCRIPTION
    Script generado automáticamente para validar: Test invoice search by specific reference number
    
    Test Case: invoice_reference_search_8677072
    Categoría: search
...
.EXAMPLE  
    .\curl_test_invoice_reference_search_8677072.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Invoice Reference Search 8677072" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-invoice_reference_search_8677072-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "me puedes traer la factura referencia 8677072"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Invoice Reference Search 8677072"
        ...
        $resultFile = "../../results/result_invoice_reference_search_8677072_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Invoice Reference Search 8677072 completado!"
