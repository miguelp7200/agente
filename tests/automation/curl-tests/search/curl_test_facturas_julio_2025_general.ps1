# ===== SCRIPT CURL AUTOMATIZADO: Facturas Julio 2025 General =====
<#
.SYNOPSIS
    Test automatizado: Facturas Julio 2025 General

.DESCRIPTION
    Script generado automáticamente para validar: Test general search for all invoices in July 2025 without specific company or solicitante filters
    
    Test Case: facturas_julio_2025_general
    Categoría: search
...
.EXAMPLE
    .\curl_test_facturas_julio_2025_general.ps1
    
.EXAMPLE  
    .\curl_test_facturas_julio_2025_general.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Facturas Julio 2025 General" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-facturas_julio_2025_general-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas de Julio 2025"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Facturas Julio 2025 General"
        ...
        $resultFile = "../../results/result_facturas_julio_2025_general_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Facturas Julio 2025 General completado!"
