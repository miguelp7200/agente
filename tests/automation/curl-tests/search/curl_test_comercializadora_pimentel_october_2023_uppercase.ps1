# ===== SCRIPT CURL AUTOMATIZADO: Comercializadora Pimentel October 2023 Uppercase =====
<#
.SYNOPSIS
    Test automatizado: Comercializadora Pimentel October 2023 Uppercase

.DESCRIPTION
    Script generado automáticamente para validar: Test company name search with uppercase format for October 2023
    
    Test Case: comercializadora_pimentel_october_2023_uppercase
    Categoría: search
...
.EXAMPLE
    .\curl_test_comercializadora_pimentel_october_2023_uppercase.ps1
    
.EXAMPLE  
    .\curl_test_comercializadora_pimentel_october_2023_uppercase.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Comercializadora Pimentel October 2023 Uppercase" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-comercializadora_pimentel_october_2023_uppercase-$(Get-Date -Format 'yyyyMMddHHmmss')"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Comercializadora Pimentel October 2023 Uppercase"
        ...
        $resultFile = "../../results/result_comercializadora_pimentel_october_2023_uppercase_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Comercializadora Pimentel October 2023 Uppercase completado!"
