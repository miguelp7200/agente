# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Proveedor =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Proveedor

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas por nombre de proveedor usando LIKE
    
    Test Case: search_invoices_by_proveedor
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_proveedor.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_proveedor.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Proveedor" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_proveedor-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame facturas de Comercializadora Pimentel"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_by_proveedor"
            test_name = "Search Invoices By Proveedor"
        ...
        $resultFile = "../../results/result_search_invoices_by_proveedor_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Proveedor completado!"
