# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Rut And Date Range =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Rut And Date Range

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas por RUT en un rango de fechas específico
    
    Test Case: search_invoices_by_rut_and_date_range
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_rut_and_date_range.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_rut_and_date_range.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Rut And Date Range" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_rut_and_date_range-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas del rut 96568740 entre el 01-01-2024 y 31-12-2024"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_by_rut_and_date_range"
            test_name = "Search Invoices By Rut And Date Range"
        ...
        $resultFile = "../../results/result_search_invoices_by_rut_and_date_range_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Rut And Date Range completado!"
