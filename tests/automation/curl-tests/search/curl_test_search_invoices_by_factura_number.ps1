# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Factura Number =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Factura Number

.DESCRIPTION
    Script generado automáticamente para validar: Buscar factura por número específico de factura
    
    Test Case: search_invoices_by_factura_number
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_factura_number.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_factura_number.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Factura Number" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_factura_number-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "necesito me busques factura 0105473148"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Search Invoices By Factura Number"
        ...
        $resultFile = "../../results/result_search_invoices_by_factura_number_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Factura Number completado!"
