# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Minimum Amount =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Minimum Amount

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas con monto mínimo específico
    
    Test Case: search_invoices_by_minimum_amount
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_minimum_amount.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_minimum_amount.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Minimum Amount" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_minimum_amount-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas con monto mayor a 1000000"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_by_minimum_amount"
            test_name = "Search Invoices By Minimum Amount"
        ...
        $resultFile = "../../results/result_search_invoices_by_minimum_amount_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Minimum Amount completado!"
