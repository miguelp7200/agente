# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Multiple Ruts =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Multiple Ruts

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas de múltiples RUTs simultáneamente
    
    Test Case: search_invoices_by_multiple_ruts
    Categoría: search
...
.EXAMPLE
    .\curl_test_search_invoices_by_multiple_ruts.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_multiple_ruts.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Multiple Ruts" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_multiple_ruts-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas de los ruts 96568740 y 61308000"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "search_invoices_by_multiple_ruts"
            test_name = "Search Invoices By Multiple Ruts"
        ...
        $resultFile = "../../results/result_search_invoices_by_multiple_ruts_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Multiple Ruts completado!"
