# ===== SCRIPT CURL AUTOMATIZADO: List Zip Files =====
<#
.SYNOPSIS
    Test automatizado: List Zip Files

.DESCRIPTION
    Script generado automáticamente para validar: Listar archivos ZIP generados disponibles en el sistema
    
    Test Case: list_zip_files
    Categoría: zip_operations
...
.EXAMPLE
    .\curl_test_list_zip_files.ps1
    
.EXAMPLE  
    .\curl_test_list_zip_files.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: List Zip Files" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-list_zip_files-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "qué archivos ZIP tengo disponibles?"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultFile = "../../results/result_list_zip_files_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test List Zip Files completado!"
