# ===== SCRIPT CURL AUTOMATIZADO: Get Monthly Amount Statistics =====
<#
.SYNOPSIS
    Test automatizado: Get Monthly Amount Statistics

.DESCRIPTION
    Script generado automáticamente para validar: Obtener estadísticas de montos por mes
    
    Test Case: get_monthly_amount_statistics
...
.EXAMPLE
    .\curl_test_get_monthly_amount_statistics.ps1
    
.EXAMPLE  
    .\curl_test_get_monthly_amount_statistics.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Monthly Amount Statistics" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_monthly_amount_statistics-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "puedes darme el total del monto por cada mes?"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Get Monthly Amount Statistics"
        ...
        $resultFile = "../../results/result_get_monthly_amount_statistics_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Monthly Amount Statistics completado!"
