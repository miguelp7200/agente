# ===== SCRIPT CURL AUTOMATIZADO: Get Zip Statistics =====
<#
.SYNOPSIS
    Test automatizado: Get Zip Statistics

.DESCRIPTION
    Script generado automáticamente para validar: Obtener estadísticas de operaciones ZIP en el sistema
    
    Test Case: get_zip_statistics
...
.EXAMPLE
    .\curl_test_get_zip_statistics.ps1
    
.EXAMPLE  
    .\curl_test_get_zip_statistics.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Zip Statistics" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_zip_statistics-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "cuántos archivos ZIP se han generado?"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "get_zip_statistics"
            test_name = "Get Zip Statistics"
        ...
        $resultFile = "../../results/result_get_zip_statistics_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Zip Statistics completado!"
