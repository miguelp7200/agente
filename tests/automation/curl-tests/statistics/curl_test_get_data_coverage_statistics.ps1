# ===== SCRIPT CURL AUTOMATIZADO: Get Data Coverage Statistics =====
<#
.SYNOPSIS
    Test automatizado: Get Data Coverage Statistics

.DESCRIPTION
    Script generado automáticamente para validar: Obtener estadísticas de cobertura temporal del dataset
    
    Test Case: get_data_coverage_statistics
...
.EXAMPLE
    .\curl_test_get_data_coverage_statistics.ps1
    
.EXAMPLE  
    .\curl_test_get_data_coverage_statistics.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Data Coverage Statistics" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_data_coverage_statistics-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "cuál es la cobertura de años del dataset?"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Get Data Coverage Statistics"
        ...
        $resultFile = "../../results/result_get_data_coverage_statistics_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Data Coverage Statistics completado!"
