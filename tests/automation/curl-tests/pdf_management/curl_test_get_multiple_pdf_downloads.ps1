# ===== SCRIPT CURL AUTOMATIZADO: Get Multiple Pdf Downloads =====
<#
.SYNOPSIS
    Test automatizado: Get Multiple Pdf Downloads

.DESCRIPTION
    Script generado automáticamente para validar: Obtener múltiples PDFs de facturas por número de factura con parámetro pdf_type
    
    Test Case: get_multiple_pdf_downloads
...
.EXAMPLE
    .\curl_test_get_multiple_pdf_downloads.ps1
    
.EXAMPLE  
    .\curl_test_get_multiple_pdf_downloads.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Multiple Pdf Downloads" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_multiple_pdf_downloads-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame los PDFs de las facturas 0105473148 y 0105473149"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Get Multiple Pdf Downloads"
        ...
        $resultFile = "../../results/result_get_multiple_pdf_downloads_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Multiple Pdf Downloads completado!"
