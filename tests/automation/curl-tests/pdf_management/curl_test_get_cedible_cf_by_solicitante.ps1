# ===== SCRIPT CURL AUTOMATIZADO: Get Cedible Cf By Solicitante =====
<#
.SYNOPSIS
    Test automatizado: Get Cedible Cf By Solicitante

.DESCRIPTION
    Script generado automáticamente para validar: Obtener PDFs cedibles CF de un solicitante específico
    
    Test Case: get_cedible_cf_by_solicitante
...
.EXAMPLE
    .\curl_test_get_cedible_cf_by_solicitante.ps1
    
.EXAMPLE  
    .\curl_test_get_cedible_cf_by_solicitante.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Cedible Cf By Solicitante" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_cedible_cf_by_solicitante-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame los PDFs cedibles CF del solicitante 0012148561"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "get_cedible_cf_by_solicitante"
            test_name = "Get Cedible Cf By Solicitante"
        ...
        $resultFile = "../../results/result_get_cedible_cf_by_solicitante_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Cedible Cf By Solicitante completado!"
