# ===== SCRIPT CURL AUTOMATIZADO: Search Invoices By Rut And Amount =====
<#
.SYNOPSIS
    Test automatizado: Search Invoices By Rut And Amount

.DESCRIPTION
    Script generado automáticamente para validar: Buscar facturas por RUT y monto mínimo con información de PDFs
    
    Test Case: search_invoices_by_rut_and_amount
...
.EXAMPLE
    .\curl_test_search_invoices_by_rut_and_amount.ps1
    
.EXAMPLE  
    .\curl_test_search_invoices_by_rut_and_amount.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Search Invoices By Rut And Amount" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-search_invoices_by_rut_and_amount-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame las facturas del rut 96568740 con monto mayor a 500000"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        $resultData = @{
            ...
            test_name = "Search Invoices By Rut And Amount"
        ...
        $resultFile = "../../results/result_search_invoices_by_rut_and_amount_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Search Invoices By Rut And Amount completado!"
