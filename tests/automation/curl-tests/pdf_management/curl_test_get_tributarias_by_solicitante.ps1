# ===== SCRIPT CURL AUTOMATIZADO: Get Tributarias By Solicitante =====
<#
.SYNOPSIS
    Test automatizado: Get Tributarias By Solicitante

.DESCRIPTION
    Script generado automáticamente para validar: Obtener todas las copias tributarias (CF y SF) de un solicitante
    
    Test Case: get_tributarias_by_solicitante
...
.EXAMPLE
    .\curl_test_get_tributarias_by_solicitante.ps1
    
.EXAMPLE  
    .\curl_test_get_tributarias_by_solicitante.ps1 -Environment Local -Verbose
#>
...
Write-Host "   TEST: Get Tributarias By Solicitante" -ForegroundColor Magenta
...
# Variables del test
$sessionId = "auto-test-get_tributarias_by_solicitante-$(Get-Date -Format 'yyyyMMddHHmmss')"
$userId = "automation-test-user"
$appName = "gcp-invoice-agent-app"
$testQuery = "dame todas las copias tributarias del solicitante 0012148561"
...
📈 RESULTADO FINAL:" -ForegroundColor Magenta
        ...
        # Guardar resultado
        $resultData = @{
            test_case = "get_tributarias_by_solicitante"
            test_name = "Get Tributarias By Solicitante"
        ...
        $resultFile = "../../results/result_get_tributarias_by_solicitante_$(Get-Date -Format 'yyyyMMddHHmmss').json"
...
Write-Success "Test Get Tributarias By Solicitante completado!"
