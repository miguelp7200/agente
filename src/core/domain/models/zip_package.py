...
class ZipPackage:
    ...
    def __post_init__(self):
        ...
        if self.expires_at is None:
            ...
            object.__setattr__(self, 'expires_at', 
                             self.created_at + timedelta(days=expiration_days))
    ...
    def with_status(self, new_status: ZipStatus, error_message: Optional[str] = None) -> 'ZipPackage':
        """
    ...
    def with_download_info(self, gcs_path: str, download_url: str, 
                          file_size_bytes: int, pdf_count: int) -> 'ZipPackage':
        """
    ...
    def __repr__(self) -> str:
        return (f"ZipPackage(package_id={self.package_id!r}, "
